    ...
    <div className="w-full max-w-4xl mx-auto" data-testid="controls">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="p-6 space-y-6">
          ...
          {hasPlayerNames && (
            <div className="bg-gray-50rounded-lg p-4 border border-gray-200">
              <div className="flex items-center justify-center gap-6">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-gray-600"></div>
                  <span className="font-medium text-gray-700">{playerNames.playerLeft}</span>
                </div>
                <div className="text-gray-400 font-medium">VS</div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-gray-600"></div>
                  <span className="font-medium text-gray-700">{playerNames.playerRight}</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="px-6 py-3 font-medium rounded-md transition-all duration-200 hover:bg-gray-50"
              disabled={winner !== null}
            >
            ...
            <div className="text-center">
              <div
                className={cn(
                  ...
                  {
                    'bg-gray-100 text-gray-700 border-gray-300': isPlaying || winner,
          ...
          {(isPlaying || gameState === GameState.PAUSED) && hasPlayerNames && (
            <div className="bg-gray-50/50 rounded-lg p-4 border border-gray-200">
              <h4 className="text-center font-medium text-gray-700 mb-3 flex items-center justify-center gap-2">
                <GamepadIcon className="w-4 h-4" />
                Keyboard Controls
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="text-center p-3 bg-white rounded-md border border-gray-200">
                  <div className="font-medium text-gray-700 mb-2">{playerNames.playerLeft}</div>
                  <div className="space-x-2">
                    <kbd className="inline-flex items-center px-2 py-1 bg-gray-100 text-gray-800 rounded text-sm font-mono border border-gray-300">
                      W
                    </kbd>
                ...
                <div className="text-center p-3 bg-white rounded-md border border-gray-200">
                  <div className="font-medium text-gray-700 mb-2">{playerNames.playerRight}</div>
                  <div className="space-x-2">
                    <kbd className="inline-flex items-center px-2 py-1 bg-gray-100 text-gray-800 rounded text-sm font-mono border border-gray-300">
                      ↑
                    </kbd>
                  ...
                  <div className="text-xs text-gray-500 mt-1">Arrow Keys</div>
                </div>
              </div>
